...
> Mean, median, mode, std-dev without numpy

[![PyPI version](https://badge.fury.io/py/math-stats.svg)](https://pypi.org/project/math-stats/)
...
```bash
pip install math-stats
```

## Quick Start

```python
from math_stats import stats
